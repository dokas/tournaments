...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{ asset(env('THEME').'/back/css/AdminLTE.min.css') }}">
  <!-- AdminLTE Skins. -->
  <link rel="stylesheet" href="{{ asset(env('THEME').'/back/css/skins/skin-blue.min.css') }}">
  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href=""><i class="fa fa-list"></i> <span>@lang('Categories')</span></a></li>
...
<!-- AdminLTE App -->
<script src="{{ asset(env('THEME').'/back/js/app.min.js') }}"></script>
