...
@section('button')
    <a href="{{ route('tournaments.create') }}" class="btn btn-primary">@lang('New Tournament')</a>
@endsection
            ...
            <div class="box">
                ...
                <div class="box-body table-responsive">
                    <table id="users" class="table table-striped table-bordered">
                        ...
                        <tbody id="pannel">
                        @if (session('tournament-ok'))
                            @component(env('THEME').'.back.components.alert')
                            @slot('type')
                            success
                            @endslot
                            {!! session('tournament-ok') !!}
                            @endcomponent
                        @endif
                        @include(env('THEME').'.back.tournaments.table', compact('tournaments'))
                        </tbody>
                    </table>
                </div>
                <!-- /.box-body -->
...
@section('js')
    ...
    <script>
        ...
        var tournament = (function () {
            ...
            var swalTitle = '@lang('Really destroy tournament ?')'
        ...
        $(document).ready(tournament.onReady)
